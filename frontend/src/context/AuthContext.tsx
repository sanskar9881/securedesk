...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    legitimate: "Legitimate", suspicious: "Suspicious",
  ...
  hi: {
    ...
    sign_out: "साइन आउट", welcome_back: "वापसी पर स्वागत", total_sent: "कुल भेजा",
    legitimate: "वैध", suspicious: "संदिग्ध", recent_transactions: "हाल के लेनदेन",
    no_transactions: "कोई लेनदेन नहीं", send_first: "पहली फ़ाइल भेजें →",
    ...
    save: "सहेजें", cancel: "रद्द करें", edit_profile: "प्रोफ़ाइल संपादित करें",
    loading: "लोड हो रहा है...", platform_overview: "प्लेटफ़ॉर्म अवलोकन",
    total_users: "कुल उपयोगकर्ता", transactions: "लेनदेन", admins: "व्यवस्थापक",
  },
  mr: {
    ...
    sign_out: "साइन आउट", welcome_back: "परत स्वागत", total_sent: "एकूण पाठवले",
    legitimate: "वैध", suspicious: "संशयास्पद", recent_transactions: "अलीकडील व्यवहार",
    no_transactions: "व्यवहार नाहीत", send_first: "पहिली फाइल पाठवा →",
    recipient: "प्राप्तकर्ता", subject: "विषय", file: "फाइल", status: "स्थिती",
    risk: "धोका", date: "तारीख", settings: "सेटिंग्ज", profile: "प्रोफाइल",
    language: "भाषा", privacy_center: "गोपनीयता केंद्र", dark_mode: "डार्क मोड",
    save: "जतन करा", cancel: "रद्द करा", edit_profile: "प्रोफाइल संपादित करा",
    loading: "लोड होत आहे...", platform_overview: "प्लॅटफॉर्म आढावा",
    total_users: "एकूण वापरकर्ते", transactions: "व्यवहार", admins: "प्रशासक",
  },
  gu: {
    dashboard: "ડૅશબોર્ડ", send_file: "ફાઇલ મોકલો", history: "મારો ઇતિહાસ",
    phishing: "ફિશિંગ ડિટેક્ટર", ai_assistant: "AI સહાયક", users: "વપરાશકર્તા",
    sign_out: "સાઇન આઉટ", welcome_back: "પાછા સ્વાગત", total_sent: "કુલ મોકલ્યું",
    legitimate: "કાનૂની", suspicious: "શંકાસ્પદ", recent_transactions: "તાજેતરના વ્યવહારો",
    no_transactions: "વ્યવહારો નથી", send_first: "પ્રથમ ફાઇલ મોકલો →",
    ...
    save: "સાચવો", cancel: "રદ કરો", edit_profile: "પ્રોફાઇલ સંપાદિત કરો",
    loading: "લોડ થઈ રહ્યું છે...", platform_overview: "પ્લેટફોર્મ ઝાંખી",
    total_users: "કુલ વપરાશકર્તા", transactions: "વ્યવહારો", admins: "એડમિન",
  },
  ta: {
    ...
    sign_out: "வெளியேறு", welcome_back: "மீண்டும் வரவேற்கிறோம்",
    total_sent: "மொத்தம் அனுப்பியது", legitimate: "சட்டபூர்வமான",
    suspicious: "சந்தேகாஸ்பதமான", recent_transactions: "சமீபத்திய பரிவர்த்தனைகள்",
    no_transactions: "பரிவர்த்தனைகள் இல்லை", send_first: "முதல் கோப்பை அனுப்பு →",
    ...
    save: "சேமி", cancel: "ரத்து", edit_profile: "சுயவிவரம் திருத்து",
    loading: "ஏற்றுகிறது...", platform_overview: "தளம் மேலோட்டம்",
    total_users: "மொத்த பயனர்கள்", transactions: "பரிவர்த்தனைகள்", admins: "நிர்வாகிகள்",
  },
};
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (token && role && name) {
      setUser({ token, role, name, avatar_color: avatarColor, language: lang });
    }
    setLoading(false);
  }, []);
