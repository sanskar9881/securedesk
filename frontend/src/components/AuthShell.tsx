...
export function AsideProof({
  ...
  return (
    <div className="max-w-[440px]">
      ...
      <dl className="mt-9 border-t border-[color:var(--line-1)]">
        {points.map((p) => (
          <div key={p.k} className="flex items-start gap-5 py-3.5 border-b border-[color:var(--line-1)]">
            <dt className="mono text-[10.5px] tracking-[0.1em] uppercase text-[color:var(--text-4)] w-[104px] flex-none pt-0.5">
              {p.k}
            </dt>
      ...
      <div className="mt-8 flex items-start gap-2.5">
        <Mark size={15} tone="var(--accent)" className="mt-0.5 flex-none" />
