  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "splash-mark":{ "0%,100%": { opacity: "1", transform: "scale(1)" }, "50%": { opacity: ".72", transform: "scale(.94)" } },
        "splash-glow":{ "0%,100%": { opacity: ".5", transform: "scale(.8)" }, "50%": { opacity: "0", transform: "scale(1.5)" } },
      },
      animation: {
        ...
        "splash-mark": "splash-mark 1.6s cubic-bezier(.4,0,.6,1) infinite",
        "splash-glow": "splash-glow 1.6s cubic-bezier(.4,0,.6,1) infinite",
      },
    },
  },
  plugins: [],
